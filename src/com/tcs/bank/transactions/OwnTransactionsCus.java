...
public class OwnTransactionsCus extends HttpServlet{
		...
		try {
			...
			if("DebitFrom".equals(selectOperation)){
				 ...
				 if(transferAmount<debiterAccBal){
					 ...
					 RequestDispatcher rds=req.getRequestDispatcher("OwnTransferCus.jsp");
				...
				if("CreditTo".equals(selectOperation)){
					...
					}else
					{
						out.println("Insufficient Balance in your account.");
						 System.out.println("No bal"); 
						 RequestDispatcher dispatcher=req.getRequestDispatcher("OwnTransferCus.jsp");
						 dispatcher.include(req, resp);
					}
